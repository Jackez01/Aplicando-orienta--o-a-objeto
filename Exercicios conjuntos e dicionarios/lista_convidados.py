...
while True:
    lista_convidados = input('Digite o nome do convidado:')

    if lista_convidados.lower() == 'sair':
        break

    convidados.add(lista_convidados)

print(f'Os convidados confirmados foram: {', '.join(convidados)}')
